...
-   **Toma de datos en campo con herramientas móviles** – Práctica con *QFIELD, OruxMaps* e *iPhone* para optimizar la captura y gestión de datos geoespaciales en inventarios forestales.
...
La inscripción al curso es grauita a través de la plataforma MOOC-UCO Digital. Sin embargo, para obtener el certificado oficial de participación y reconocimiento de créditos, se recomienda encarecidamente el paso de la tasa correspondiente al final del curso.

Dado que el número de plazas es limitado, pedimos a los interesados que solo se inscriban si realmente podrán asistir. En caso de no poder participar, rogamos que lo comuniquen con la mayor antelación posible para que otra persona pueda ocupar su lugar.
...
## {{< fa circle-question >}} **Es grauito el curso?**

Sí, la inscripción es gratuita a través de MOOC-UCO Digital. Sin embargo, para obtener el certificado oficial de participación y reconocimiento de créditos, se recomienda encarecidamente el pago de la tasa correspondiente.
:::
...
**Online**: máximo de 30 plazas disponibles.
:::
