...
varo <- "00_assets/figures/informacion-docentes/m_angeles_varo/foto_m_angeles_varo.jpg"
```
...
div(
  ...
  tags$button(
    ...
    tags$a(
      ...
      tags$i(class = "fa-brands fa-linkedin", style = "margin-right: 8px;"),
      "Linkedin",
      href   = "https://www.linkedin.com/in/m%C2%AA-%C3%A1ngeles-varo-72568729/",
      style  = "text-decoration: none;",
      target = "_blank"
    )
  )
