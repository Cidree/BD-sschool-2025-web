...
La realización del curso tiene un coste de **67,75€** en ambas modalidades. El aprovechamiento del mismo incluye un **certificado oficial de participación y reconocimiento**.
...
Si tienes alguna duda, puedes ponerte en contacto con nosotros a través del correo {{< fa envelope >}} [mastergeoforest@uco.es](mailto: mastergeoforest@uco.es)
