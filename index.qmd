...
maplibre(
  ...
  add_categorical_legend(
    legend_title = NULL,
    colors = c("red", "blue"),
    values = c("Edificio Da Vinci", "Estación RENFE")
  ) |> 
